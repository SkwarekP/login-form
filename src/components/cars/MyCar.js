                ...
                if (data.tankList.length > 0) {
                    ...
                    setStats({
                        ...
                        paliwo: data.tankList
                            ...
                            .reduce((a, b) => a + b),
                        iloscLitrow: data.tankList
                            .map((singleTank) => singleTank.ilosc)
                            .reduce((a, b) => a + b),
                        iloscTankowan: data.tankList.length
                    });
                } else {
                }
            });
                ...
                <div className="container-fluid">
                    <Row>
                        <div className="page-title mt-2 ml-2">
                            <h1 className="ml-2 mt-2 text-unwrap">{carInfo.marka + " " + carInfo.model}</h1>
                        </div>
                    </Row>
                    <Row>
                        ...
                        <Col xs={12} className="as-box-rounded-white mt-3">
                            ...
                            <Row className="single_cars_info">
                                ...
                                <Col xs={12} lg={4} className="single_cars">
                                    <div className="single_car_info">
                                        <div>
                                            <span>{stats.iloscTankowan} </span>
                                        </div>
                                        <p>Łączna liczba tankowań</p>
                                    </div>
                                </Col>
                            </Row>
                        </Col>
